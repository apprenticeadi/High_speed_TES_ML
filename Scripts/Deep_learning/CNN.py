...
time_series, labels = return_artifical_data(500,1.8, 5)
...
input_shape = (time_series.shape[1], 1)
...
targetTraces = Traces(frequency=500, data=actual_data, multiplier=3, num_bins=1000)
