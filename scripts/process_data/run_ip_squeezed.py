...
data_date = '2024-07-17-1954'
data_keywords = ['2nmPump', '112uW', data_date]
...
fig1, axs1 = plt.subplots(2, 2, figsize=(19, 9), layout='constrained', sharex='row', sharey='row')
for i_ch, channel in enumerate(channels):
    ...
    traces = Traces(effective_rep_rate, data, parse_data=False)
